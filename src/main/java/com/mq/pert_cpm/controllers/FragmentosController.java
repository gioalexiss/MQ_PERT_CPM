...
public class FragmentosController {
    ...
    @GetMapping("/fragmentos/documentacion")
    public String obtenerDocumentacion() {
        return "fragmentos/documentacion"; // Retorna el archivo documentacion.html que acabamos de crear
    }
}
